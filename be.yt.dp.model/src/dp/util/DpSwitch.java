 ...
 * @generated
 */
public class DpSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case DpPackage.STOCK_ITEM: {
				StockItem stockItem = (StockItem)theEObject;
				T result = caseStockItem(stockItem);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DpPackage.CATEGORIE: {
				Categorie categorie = (Categorie)theEObject;
				T result = caseCategorie(categorie);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DpPackage.DIEPVRIES: {
				Diepvries diepvries = (Diepvries)theEObject;
				T result = caseDiepvries(diepvries);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DpPackage.SCHUIF: {
				Schuif schuif = (Schuif)theEObject;
				T result = caseSchuif(schuif);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DpPackage.PRODUKT: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Diepvries</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Diepvries</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseDiepvries(Diepvries object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Schuif</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Schuif</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseSchuif(Schuif object) {
		return null;
	}
